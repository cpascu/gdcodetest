<div class="js-edit-contact-modal js-modal modal fade" tabindex="-1" role="dialog">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="js-contact-add modal-body">
				<?= form_open('api/contact/edit', array('class' => 'js-form-edit', 'role' => 'form')); ?>
				<?= form_input(array(
					'type'  => 'hidden',
					'name'  => 'contactId',
			...
			<div class="modal-footer">
				...
				<button type="button" class="js-submit btn btn-primary" data-target-form=".js-form-edit">Save</button>
			</div>
		</div><!-- /.modal-content -->
	</div><!-- /.modal-dialog -->
</div><!-- /.modal -->